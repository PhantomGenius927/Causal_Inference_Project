...
da <- dyadyrs %>%
  ...
  summarise(
    ...
    gdppc = mean(gdppc_dyd, na.rm = TRUE),
    sd_gdppc = sd(gdppc_dyd, na.rm = TRUE),
    trade = mean(trade_dyd, na.rm = TRUE),
    sd_trade = sd(trade_dyd, na.rm = TRUE),
    nmc = mean(nmc_dyd, na.rm = TRUE),
    sd_nmc = sd(nmc_dyd, na.rm = TRUE)
  )
```
