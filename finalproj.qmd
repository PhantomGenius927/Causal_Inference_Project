...
twfe_betahat <- summary(twfe5)$coefficients #save the coefficients
twfe_sigma <- summary(twfe5)$cov.scaled #save the covariance matrix

twfe_betahat <- twfe_betahat["regcha_uni:kappava"]
twfe_sigma <-twfe_sigma["regcha_uni:kappava", "regcha_uni:kappava"]
delta_rm_results <- 
HonestDiD::createSensitivityResults_relativeMagnitudes(
                                    betahat = twfe_betahat, #coefficients
                                    sigma = twfe_sigma, #covariance matrix
