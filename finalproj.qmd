...
etable(pta_model, file = here::here("tables/pta.tex"))
...
etable(es_reg, file = here::here("tables/esreg.tex"))

es_regdat <- as_tibble(es_reg$coeftable)
es_regdat$tau = -8:8
es_regdat$Est = es_regdat$Estimate-es_regdat$Estimate[es_regdat$tau==-1]
...
ggplot(data = es_regdat, aes(x = tau, y = Est)) + 
  ...
  geom_hline(yintercept = 0, 
             col = "darkgrey") +
  geom_smooth(data = subset(es_regdat, tau < -1), se = TRUE) + 
  geom_smooth(data = subset(es_regdat, tau >= -1), se = TRUE)
